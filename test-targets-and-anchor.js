...
assert.strictEqual(expected.length, 121, 'excluded list must contain exactly 121 Lumens');
...
assert.strictEqual(context.CONFIG.WALK_RUN_HOLD_MS, 450, 'continuous horizontal run must last exactly 450ms per direction');
